...
CLASS zcl_dbbr_custom_f4_factory IMPLEMENTATION.
  ...
  METHOD delete_f4_by_id.
    ...
    IF ls_f4-ref_join_id IS NOT INITIAL.
      NEW zcl_dbbr_join_factory( )->delete_join( iv_join_id = ls_f4-ref_join_id ).
    ENDIF.
  ...
  METHOD delete_multiple_by_id.
    ...
    DATA(lt_join_id) = VALUE zif_sat_ty_global=>ty_t_selopt( FOR f4 IN lt_f4
  ...
  METHOD fill_corresponding_data.
    ...
    IF cs_f4_data IS SUPPLIED.
      ...
      IF cs_f4_data-ref_join_id IS NOT INITIAL.
        ...
        cs_f4_data-join_def = lr_join_factory->read_join( cs_f4_data-ref_join_id ).
      ENDIF.
    ...
    ELSEIF ct_f4_data IS SUPPLIED.
      ...
      LOOP AT ct_f4_data ASSIGNING FIELD-SYMBOL(<ls_f4>).
        IF <ls_f4>-ref_join_id IS NOT INITIAL.
          <ls_f4>-join_def = lr_join_factory->read_join( <ls_f4>-ref_join_id ).
        ENDIF.
...
*&---------------------------------------------------------------------*
    ...
    ELSE.
      ...
      IF ls_join_def-tables IS NOT INITIAL.
        ...
        ls_f4-ref_join_id = NEW zcl_dbbr_join_factory( )->save_join( is_join_def = ls_join_def ).
      ENDIF.
