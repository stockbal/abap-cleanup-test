"! <p class="shorttext synchronized">Factory for queries</p>
CLASS zcl_dbbr_sql_query_factory DEFINITION
  PUBLIC
  CREATE PRIVATE.

  PUBLIC SECTION.
    TYPES ty_t_query_history TYPE TABLE OF zdbbrsqlqh WITH EMPTY KEY.
    TYPES ty_t_history_id_range TYPE RANGE OF zdbbr_sql_query_history_id.

    "! <p class="shorttext synchronized">Retrieves SQL Query history for user</p>
    "!
    ...
    "! <p class="shorttext synchronized">Creates history for Query</p>
    "!
    ...
    "! <p class="shorttext synchronized">Updates execution time of query</p>
    CLASS-METHODS update_execution_time
      IMPORTING
        iv_query_id  TYPE zdbbr_sql_query_history_id
        iv_exec_time TYPE zdbbr_query_exec_time.

    "! <p class="shorttext synchronized">Deletes query history entries</p>
    "!
...
CLASS zcl_dbbr_sql_query_factory IMPLEMENTATION.
  ...
  METHOD create_history_entry.
    DATA(ls_history_entry) = VALUE zdbbrsqlqh( query_history_id = zcl_sat_system_helper=>create_guid_22( )
