...
CLASS ltcl_unit DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    DATA exp_props TYPE zif_dummy_ty_global=>ty_method_properties.

    METHODS assert_equals RAISING
                            cx_static_check.

    METHODS local_class_glob_intf       FOR TESTING RAISING cx_static_check.
    METHODS non_existing_meth_in_path   FOR TESTING RAISING cx_static_check.
    METHODS local_class_intf_alias_meth FOR TESTING RAISING cx_static_check.
    METHODS normal_abstract_method      FOR TESTING RAISING cx_static_check.
    METHODS redefined_intf_method       FOR TESTING RAISING cx_static_check.
    METHODS static_constructor          FOR TESTING RAISING cx_static_check.
    METHODS private_constructor         FOR TESTING RAISING cx_static_check.
ENDCLASS.
...
CLASS ltcl_unit IMPLEMENTATION.
  ...
  METHOD local_class_glob_intf.
    ...
    exp_props = VALUE #( name       = 'LIF_MAP_TO_OBJREF_BROKER~GET_MAPPER'
                         encl_type  = 'CLAS'
...
*    is_error_ok = abap_true.
  ...
  METHOD local_class_intf_alias_meth.
    ...
    exp_props = VALUE #( encl_type  = 'CLAS'
                         name       = 'ALIAS_FOR_RUN'
                         is_alias   = abap_true
